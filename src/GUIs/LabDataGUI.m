classdef LabDataGUI < handle
    ...
    methods
        ...
        function updateEpochFilterTable(obj)
            ...
            columnFormat = [props, obj.operators];
            columnFormat = columnFormat(~ cellfun(@(s) isempty(strtrim(s)), columnFormat));
            set(obj.handles.epochFilterTable,'ColumnFormat',{ columnFormat  'char'} )
        end
        ...
        function updateCellFilterTable(obj)
            ...
            columnFormat = [props, obj.operators];
            columnFormat = columnFormat(~ cellfun(@(s) isempty(strtrim(s)), columnFormat));
            set(obj.handles.cellFilterTable,'ColumnFormat', {columnFormat  'char'})
        end
